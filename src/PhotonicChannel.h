 ...
 */
#ifndef __PHOTONIC_BUS_H__
#define __PHOTONIC_BUS_H__
...
struct PhotonicChannel: sc_module
{
  ...
  tlm_utils::multi_passthrough_target_socket<PhotonicChannel>    targ_socket;
  tlm_utils::multi_passthrough_initiator_socket<PhotonicChannel> init_socket;

  int local_id; // Unique ID

  PhotonicChannel(sc_module_name nm, int id)
